...
<form method="post" action="insert_query.php">
    ...
    <button id="appariThema" type="button">+</button>   
    <br></br>
...
<br> </br>
  ...
  echo "</select>";}?>
              ...
              <button type="submit">Senden >>></button>
                                  ...
                                  <form method='POST' action='Insert_Thema.php' id = 'hidden_insert'> 
            <label for='comment'>Thema hinzufügen:</label>
            <textarea id='newthema' name='newthema' rows='4' cols='50' placeholder='neune Thema hinzufügen...'></textarea><br>
            <button type='submit'>Neue Thema hinzufügen >>></button>
          </form>
...
document.getElementById('appariThema').addEventListener('click', function() {
    var div = document.getElementById('hidden_insert');
    if (div.style.display === 'none') {
        div.style.display = 'block';
    } else {
        div.style.display = 'none';
